...
class StudyHubApp {
    ...
    loadNotes() {
        ...
        notesGrid.innerHTML = `
            ...
            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/array-data-structure-guide/" target="_blank" style="position: relative;">
                <h3>Arrays</h3>
                <p>Linear data structure for storing elements of the same type. Supports random access and efficient traversal.</p>
            </a>

            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/linked-list-data-structure/" target="_blank" style="position: relative;">
                <h3>Linked Lists</h3>
            ...
            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/stack-data-structure/" target="_blank" style="position: relative;">
                <h3>Stacks</h3>
                <p>LIFO (Last In First Out) structure. Supports push and pop operations. Used in function calls, expression evaluation, etc.</p>
            </a>

            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/queue-data-structure/" target="_blank" style="position: relative;">
                <h3>Queues</h3>
                <p>FIFO (First In First Out) structure. Supports enqueue and dequeue operations. Used in scheduling, buffering, etc.</p>
            </a>

            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/tree-data-structure/" target="_blank" style="position: relative;">
                <h3>Trees</h3>
                <p>Hierarchical data structure with nodes connected by edges. Binary trees, BSTs, AVL trees, etc. are common types.</p>
            </a>
            <a class="note-card dsa fade-in" href="https://www.geeksforgeeks.org/dsa/graph-data-structure/" target="_blank" style="position: relative;">
                <h3>Graphs</h3>
